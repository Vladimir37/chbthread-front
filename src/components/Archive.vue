<template>
    <div :class="{
        ...
        <b-alert class="archiveAlert" show>Вы находитесь в архиве. Здесь хранятся анкеты, созданные больше года назад.</b-alert>
        ...
        <h2 v-else>
            В архиве пока нет анкет. Попробуйте поискать на <span class="errLink" @click="toMain">главной</span>.
        </h2>
    </div>
</template>
...
export default {
    ...
    methods: {
        getProfiles() {
            provider.get('/profiles/getArchive').then(res => {
